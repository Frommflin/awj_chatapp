  ...
  return (
    <form id='register' onSubmit={handleRegistration}> 
        ...
        <div className="input-group mb-3">
            ...
            <input type="email" placeholder="example@example.com"  className="form-control" aria-label="Email" aria-describedby="email" />
        </div>
        <div className="input-group mb-3">
            <span id='avatar' className="input-group-text">Avatar</span>
            <input type="url" placeholder="Avatar URL"  className="form-control" aria-label="Avatar" aria-describedby="avatar" />
        </div>
